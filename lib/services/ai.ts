...
export const aiEN: ServiceContent = {
  ...
  lead: "Woodstone Studio is a digital technology studio building AI solutions for businesses. Chat assistants, task-running AI agents and automations that remove repetitive work — integrated into your existing software and processes. We run AI in production in our own products.",
