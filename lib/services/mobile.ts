...
export const mobileTR: ServiceContent = {
  ...
  h1: ["İzmir'de mobil uygulama:", "fikirden mağazaya."],
  lead: "Woodstone Studio, İzmir merkezli bir dijital teknoloji stüdyosudur. Flutter ile tek kod tabanından iOS ve Android uygulamalar geliştiriyor; tasarımdan App Store ve Google Play yayınına kadar tüm süreci üstleniyoruz. Kendi uygulamalarımız mağazalarda yayında — süreci yaşayarak biliyoruz.",
...
export const mobileEN: ServiceContent = {
  ...
  lead: "Woodstone Studio is a digital technology studio based in İzmir, Turkey. We build iOS and Android apps from a single Flutter codebase and handle everything from design to App Store and Google Play release. Our own apps are live in both stores — we know the process first-hand.",
...
export const mobileSQ: ServiceContent = {
  ...
  lead: "Woodstone Studio është një studio teknologjie dixhitale që punon me klientë në Shqipëri, Kosovë dhe rajon. Ndërtojmë aplikacione iOS dhe Android nga një kod i vetëm Flutter dhe kujdesemi për gjithçka, nga dizajni deri te publikimi në App Store dhe Google Play. Aplikacionet tona janë live në të dyja dyqanet — procesin e njohim nga përvoja.",
