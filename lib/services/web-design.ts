...
export const webDesignTR: ServiceContent = {
  ...
  alternates,
  meta: {
    title: "Kurumsal Web Tasarım ve Web Sitesi Tasarımı",
    description:
      "Kurumsal web tasarım ve web sitesi tasarımı: kurumsal siteler, tanıtım siteleri ve e-ticaret; hızlı, mobil uyumlu ve arama motoru dostu. Ücretsiz ön görüşme.",
    keywords: [
  ...
  eyebrow: "Kurumsal Web Tasarım",
  h1: ["Web tasarım:", "hızlı, sade, satan siteler."],
  lead: "WoodstoneStudio, uzaktan çalışan bir dijital teknoloji stüdyosudur; Türkiye'nin her yerinden ve yurt dışından müşterilerle çalışıyoruz. Kurumsal web siteleri, tanıtım siteleri ve e-ticaret arayüzlerini tasarlıyor ve geliştiriyoruz — her biri hız, mobil uyumluluk ve Google'da görünürlük düşünülerek kurulur.",
  ...
  faq: [
    ...
    { q: "Farklı şehir ya da ülkedeki firmalarla çalışıyor musunuz?", a: "Evet. Türkiye genelinde ve yurt dışında müşterilerle uzaktan çalışıyoruz; görüşmeler online yapılır, siteniz tek dilde ya da istediğiniz kadar dilde (çok dilli) hazırlanabilir." },
...
export const webDesignEN: ServiceContent = {
  ...
  meta: {
    ...
    description:
      "Corporate website design studio working with clients worldwide. Corporate websites, landing pages and e-commerce — fast, mobile-first and built to rank. Free consultation.",
    keywords: [
      "web design studio",
  ...
  lead: "WoodstoneStudio is a remote-first digital technology studio working with clients across Turkey, Europe and beyond. We design and build corporate websites, landing pages and e-commerce storefronts — each one made for speed, mobile use and visibility on Google.",
  ...
  faq: [
    ...
    { q: "Do you work with clients outside Turkey?", a: "Yes. We work remotely with clients across Turkey, Europe and worldwide; sites can be delivered in a single language or in as many languages as you need." },
