...
export const socialTR: ServiceContent = {
  ...
  h1: ["İzmir'de sosyal medya yönetimi:", "düzenli içerik, kalıcı görünürlük."],
  lead: "Woodstone Studio, İzmir merkezli bir dijital teknoloji stüdyosudur. Instagram ve YouTube hesaplarınızı yönetiyor, markanıza uygun içerik üretiyor ve organik büyümeyi destekliyoruz. Odağımız kısa vadeli rakamlar değil; markanızı doğru kitleye ulaştıran, kalıcı bir sosyal medya varlığı.",
...
export const socialEN: ServiceContent = {
  ...
  lead: "Woodstone Studio is a digital technology studio based in İzmir, Turkey. We manage your Instagram and YouTube accounts, produce content in your brand's voice and support organic growth. Our focus is not short-term numbers but a lasting social presence that reaches the right audience.",
...
export const socialSQ: ServiceContent = {
  ...
  lead: "Woodstone Studio është një studio teknologjie dixhitale që punon me biznese në Shqipëri, Kosovë dhe rajon. Menaxhojmë llogaritë tuaja në Instagram dhe YouTube, prodhojmë përmbajtje në zërin e markës suaj dhe mbështesim rritjen organike. Fokusi ynë nuk janë numrat afatshkurtër, por një prani e qëndrueshme që arrin te audienca e duhur.",
